                ...
                <div className="flex flex-col sm:flex-row gap-3 pt-4 border-t border-black/5 dark:border-white/5 justify-end">
                  {activeProject.github && (
                    <a
                      ...
                      className="btn-outline flex items-center justify-center gap-2 text-xs py-2 px-4 shadow-sm w-full sm:w-auto"
                    >
                  ...
                  {activeProject.link && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="btn-primary flex items-center justify-center gap-2 text-xs py-2 px-4 shadow-sm w-full sm:w-auto"
                    >
