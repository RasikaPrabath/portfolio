...
const TechIcon = ({ name }) => {
  const icons = {
    ...
    "Node.js": (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full text-[#339933]">
    ...
    "JavaScript": (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full text-[#F7DF1E]">
    ...
    "Java": (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full text-[#007396]">
    ...
    "MySQL": (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full text-[#4479A1]">
        <path d="M16.405 5.501c-.115 0-.193.014-.274.033v.013h.014c.054.104.146.18.214.273.054.107.1.214.154.32l.014-.015c.094-.066.14-.172.14-.333-.04-.047-.046-.094-.08-.14-.04-.067-.126-.1-.18-.153zM5.77 18.695h-.927a50.854 50.854 0 00-.27-4.41h-.008l-1.41 4.41H2.45l-1.4-4.41h-.01a72.892 72.892 0 00-.195 4.41H0c.055-1.966.192-3.81.41-5.53h1.15l1.335 4.064h.008l1.347-4.064h1.095c.242 2.015.384 3.86.428 5.53zm4.017-4.08c-.378 2.045-.876 3.533-1.492 4.46-.482.716-1.01 1.073-1.583 1.073-.153 0-.34-.046-.566-.138v-.494c.11.017.24.026.386.026.268 0 .483-.075.647-.222.197-.18.295-.382.295-.605 0-.155-.077-.47-.23-.944L6.23 14.615h.91l.727 2.36c.164.536.233.91.205 1.123.4-1.064.678-2.227.835-3.483zm12.325 4.08h-2.63v-5.53h.885v4.85h1.745zm-3.32.135l-1.016-.5c.09-.076.177-.158.255-.25.433-.506.648-1.258.648-2.253 0-1.83-.718-2.746-2.155-2.746-.704 0-1.254.232-1.65.697-.43.508-.646 1.256-.646 2.245 0 .972.19 1.686.574 2.14.35.41.877.615 1.583.615.264 0 .506-.033.725-.098l1.325.772.36-.622zM15.5 17.588c-.225-.36-.337-.94-.337-1.736 0-1.393.424-2.09 1.27-2.09.443 0 .77.167.977.5.224.362.336.936.336 1.723 0 1.404-.424 2.108-1.27 2.108-.44 0-.77-.167-.978-.5zm-2.424-5.105c0-.562-.26-1.29-.776-2.04-.68-.875-1.674-1.396-2.743-1.396-1.06 0-1.84.437-2.335 1.31-.34.586-.51 1.256-.51 2.01 0 1.064.266 1.955.8 2.67.534.714 1.298 1.072 2.293 1.072 1.06 0 1.838-.436 2.333-1.308.34-.585.51-1.254.51-2.008v-.01z" />
      </svg>
    ),
    "Git": (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full text-[#F05032]">
        <path d="M23.546 10.93L13.067.452c-.604-.603-1.582-.603-2.188 0L8.708 2.627l2.76 2.76c.645-.215 1.379-.07 1.889.441.516.515.658 1.258.438 1.9l2.658 2.66c.645-.223 1.387-.078 1.9.435.721.72.721 1.884 0 2.604-.719.719-1.881.719-2.6 0-.539-.541-.674-1.337-.404-1.996L12.86 8.955v6.525c.176.086.342.203.488.348.713.721.713 1.883 0 2.6-.719.721-1.889.721-2.609 0-.719-.719-.719-1.879 0-2.598.182-.18.387-.316.605-.406V8.835c-.217-.091-.424-.222-.6-.401-.545-.545-.676-1.342-.396-2.009L7.636 3.7.45 10.881c-.6.605-.6 1.584 0 2.189l10.48 10.477c.604.604 1.582.604 2.186 0l10.43-10.43c.605-.603.605-1.582 0-2.187" />
      </svg>
    ),
    "VS Code": (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full text-[#007ACC]">
    ...
    "HTML": (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full text-[#E34F26]">
        <path d="M1.5 0h21l-1.91 21.563L11.977 24l-8.564-2.438L1.5 0zm7.031 9.75l-.232-2.718 10.059.003.23-2.622L5.412 4.41l.698 8.01h9.126l-.326 3.426-2.91.804-2.955-.81-.188-2.11H6.248l.33 4.171L12 19.351l5.379-1.443.744-8.157H8.531z" />
      </svg>
    ),
    "CSS": (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full text-[#1572B6]">
        <path d="M1.5 0h21l-1.91 21.563L11.977 24l-8.565-2.438L1.5 0zm17.09 4.413L5.41 4.41l.213 2.622 10.125.002-.255 2.716h-6.64l.24 2.573h6.182l-.366 3.523-2.91.804-2.956-.81-.188-2.11h-2.61l.29 3.855L12 19.288l5.373-1.53L18.59 4.414z" />
      </svg>
    ),
    "Tailwind": (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full text-[#06B6D4]">
        <path d="M12.001,4.8c-3.2,0-5.2,1.6-6,4.8c1.2-1.6,2.6-2.2,4.2-1.8c0.913,0.228,1.565,0.89,2.288,1.624 C13.666,10.618,15.027,12,18.001,12c3.2,0,5.2-1.6,6-4.8c-1.2,1.6-2.6,2.2-4.2,1.8c-0.913-0.228-1.565-0.89-2.288-1.624 C16.337,6.182,14.976,4.8,12.001,4.8z M6.001,12c-3.2,0-5.2,1.6-6,4.8c1.2-1.6,2.6-2.2,4.2-1.8c0.913,0.228,1.565,0.89,2.288,1.624 c1.177,1.194,2.538,2.576,5.512,2.576c3.2,0,5.2-1.6,6-4.8c-1.2,1.6-2.6,2.2-4.2,1.8c-0.913-0.228-1.565-0.89-2.288-1.624 C10.337,13.382,8.976,12,6.001,12z" />
      </svg>
    ),
    "Firebase": (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full text-[#FFCA28]">
        <path d="M3.89 15.672L6.255.461A.542.542 0 017.27.288l2.543 4.771zm16.794 3.692l-2.25-14a.54.54 0 00-.919-.295L3.316 19.365l7.856 4.427a1.621 1.621 0 001.588 0zM14.3 7.147l-1.82-3.482a.542.542 0 00-.96 0L3.53 17.984z" />
      </svg>
    ),
    "PHP": (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full text-[#777BB4]">
        <path d="M7.01 10.207h-.944l-.515 2.648h.838c.556 0 .97-.105 1.242-.314.272-.21.455-.559.55-1.049.092-.47.05-.802-.124-.995-.175-.193-.523-.29-1.047-.29zM12 5.688C5.373 5.688 0 8.514 0 12s5.373 6.313 12 6.313S24 15.486 24 12c0-3.486-5.373-6.312-12-6.312zm-3.26 7.451c-.261.25-.575.438-.917.551-.336.108-.765.164-1.285.164H5.357l-.327 1.681H3.652l1.23-6.326h2.65c.797 0 1.378.209 1.744.628.366.418.476 1.002.33 1.752a2.836 2.836 0 01-.305.847c-.143.255-.33.49-.561.703zm4.024.715l.543-2.799c.063-.318.039-.536-.068-.651-.107-.116-.336-.174-.687-.174h-.927l-.644 3.315h-1.378l1.23-6.326h1.378l-.449 2.317h1.027c.671 0 1.14.104 1.411.314.27.209.39.587.36 1.134l-.566 2.91zm9.007-3.581c-.13.423-.313.79-.551 1.1-.237.31-.541.524-.912.639-.37.116-.82.174-1.353.174h-.91l-.41 2.103H17.28l1.23-6.326h2.65c.797 0 1.378.209 1.744.628.366.418.476 1.002.33 1.752a2.822 2.822 0 01-.305.847c-.143.255-.33.49-.561.703zm-.897-1.947h-.838l-.515 2.648h.838c.556 0 .97-.105 1.242-.314.272-.21.455-.559.55-1.049.092-.47.05-.802-.124-.995-.175-.193-.523-.29-1.047-.29z" />
      </svg>
    ),
  };
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 md:px-8">
        ...
        <div className="grid gap-3 sm:gap-6 grid-cols-3 mt-12">
          ...
          >
            ...
            <h3 className="text-[12px] sm:text-base font-bold mb-1 sm:mb-2 text-gray-900 dark:text-white tracking-tight">Languages</h3>
            <p className="text-[10px] sm:text-sm text-gray-500 dark:text-gray-400 leading-snug sm:leading-relaxed font-light">HTML, CSS, JavaScript, PHP, C#, Java, React, Next.js, .NET</p>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-[12px] sm:text-base font-bold mb-1 sm:mb-2 text-gray-900 dark:text-white tracking-tight">Education</h3>
            <p className="text-[10px] sm:text-sm text-gray-500 dark:text-gray-400 leading-snug sm:leading-relaxed font-light break-words">BSc (Hons) in Computing and Information Systems (Undergraduate)</p>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-[12px] sm:text-base font-bold mb-1 sm:mb-2 text-gray-900 dark:text-white tracking-tight">Projects</h3>
            <p className="text-[10px] sm:text-sm text-gray-500 dark:text-gray-400 leading-snug sm:leading-relaxed font-light">Built and delivered more than 5 full-stack and automation projects</p>
          </motion.div>
        </div>
